...
import offshoreServiceNews from "../../assets/images/offshore-service-news.png";

class Outsourcing extends React.Component {

  render() {
    return (
      <div className='ui-offshore'>
        <SubPageHeader imgUrl={outsourcingBd} title={t1('Offshore services')}/>
