...
class Outsourcing extends React.Component {
  ...
  render() {
    return (
      <div className='ui-consulting'>
        <SubPageHeader imgUrl={outsourcingBd} title={t1('consulting services')}/>
        <div className='ui-news-content'>
          <h2 className='header'>~ Free consulting services from aster soft ~</h2>
          <p className='desc'>
